  ...
  return (
    <section className="px-16">
      <div className="w-full h-60 overflow-hidden">
        <img className="" src={TestingImage} />
      </div>
      ...
      <div className="flex flex-col justify-start items-start">
        ...
        <p>
          1.Welcome to our Daycare Blog! These Terms and Conditions govern your
          use of our website and outline t he rules and guidelines for accessing
          and interacting with our content. By accessing or using our website ,
          you agree to abide by these Terms and Conditions. If you do not agree
        ...
        <p>
          ...
          log in to our Daycare Blog. User accounts are restricted to authorized
          personnel only.
        </p>
        User Accounts a.{" "}
        <h1 className="text-lg font-semibold">Registration:</h1>{" "}
        <p>
          User accounts are created by administrators for authorized personnel.
          Each user is provided with unique login credentials.
        </p>
        b. <h1 className="text-lg font-semibold">Responsibilities:</h1>{" "}
        <p>
          Users are responsible for maintaining the security of their login
          credentials and preventing unauthorized access to their accounts. Any
          unauthorized use of accounts should be reported immediately to the
          administrators.
        </p>
        c. <h1 className="text-lg font-semibold">Termination:</h1>{" "}
        <p>
          Administrators reserve the right to terminate or suspend user accounts
          at their discretion, especially in cases of unauthorized access or
        ...
        <p>
          ...
          data. By using our Daycare Blog, you agree to the terms of our Privacy
          Policy.
        </p>
        ...
        <p>
          ...
          our website. Users are responsible for regularly reviewing the Terms
          and Conditions to stay informed of any updates.
        </p>
        <h1 className="text-lg font-semibold">Contact Information</h1>
        <p>
          If you have any questions or concerns about these Terms and
          Conditions, please contact us at [contact email or phone number].
        </p>
        <h1 className="text-lg font-semibold">
