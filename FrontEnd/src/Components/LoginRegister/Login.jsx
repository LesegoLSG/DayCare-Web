  ...
  return (
    <section className="w-full h-screen flex justify-center items-center">
      ...
      <div className="w-full h-screen flex justify-center items-center">
        {/* left div */}
        <div className="w-full md:w-1/2 h-screen flex flex-col justify-center items-center bg-white relative ">
          <h1 className="h1 my-6">Welcome Back</h1>
          <h2 className="h2 ">
            <span className="text-[#36C2CE]">Star Bright</span> <br /> Daycare
            Center
          </h2>

          <form
            className="mt-16 w-full flex flex-col justify-center items-center gap-y-6 "
            onSubmit={handleLoginSubmit}
          >
            <div className="w-4/5 flex flex-col justify-start items-center bg-transparent">
            ...
            <div className="w-4/5 flex flex-col justify-center items-center p-2 relative">
              {" "}
        ...
        <div className="hidden md:flex w-1/2 h-screen  justify-start items-center bg-blue-200 relative">
          ...
          <h1 className="h1 absolute top-50 left-60 text-white">
