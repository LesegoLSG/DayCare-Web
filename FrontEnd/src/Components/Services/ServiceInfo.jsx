...
const ServiceInfo = () => {
  ...
  return (
    ...
    <div className="w-full max-w-6xl bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-extrabold mb-6 text-center text-gray-800">{service.title}</h1>
        <div className="flex flex-col lg:flex-row items-center lg:items-start lg:space-x-8">
            <img src={service.imageMain} alt={service.title} className="w-full max-h-96 lg:w-1/2 rounded-lg shadow-lg mb-6 lg:mb-0" />
            <div className="flex flex-col items-center lg:items-start w-full lg:w-1/2">
                {/* <div className="w-full h-64 mb-6">
                    <Lottie animationData={service.animation.props.animationData} />
                </div> */}
                <p className="text-lg leading-relaxed text-gray-700 text-start">{service.extendedDescription}</p>
            </div>
        </div>

        <div className="flex flex-col md:flex-row justify-center items-center gap-x-2"> 
        <div className="w-full mt-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800 text-start">Key Features</h2>
        ...
        <div className=" w-full mt-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800 text-start">Benefits</h2>
            <ul className="list-disc list-inside text-gray-700 text-start">
        ...
        <button className="button mt-8" onClick={() =>navigate("/")}>Back to Home</button>
    </div>
