...
const ServicesCard = ({ singleService, onOpenModal, index }) => {
    ...
    return (
        ...
        <div className=" w-[18rem] h-[18rem] m-6 p-6 flex flex-col justify-center items-center relative rounded-full  border-4  border-solid " style={{ borderColor: colorStyling }}>
            ...
            <button className="button" onClick={() => navigate(`/servicedetails/${singleService.id}`)}>Read More</button>
        </div>
    )
}
