...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (validateForm()) {
            // Form is valid, submit the form (you can handle form submission logic here)
    ...
    return (
        <section id="contact" className="bg-primary w-full h-auto pt-20 py-16">
            <div className="flex flex-col justify-center items-center">
                <h1 className="h2 my-2">Get in Touch</h1>
            ...
            <div className="container mx-auto flex justify-center items-center  py-16 px-12 md:px-0">
                <div className="bg-white shadow-md rounded-lg w-full lg:w-3/4 xl:w-1/2 p-8">
                    ...
                    <form className="mb-4" onSubmit={handleSubmit}>
                        ...
                        <div className="w-full flex flex-row justify-center items-center gap-x-2">
                            <div className="w-full flex flex-col">
                                ...
                                <input
                                    ...
                                    id="email"
                                    name="email"
                                    className={`inputField ${errors.email ? 'border-red-500' : ''}`}
                            ...
                            <div className="w-full flex flex-col">
                                ...
                                <input
                                    ...
                                    id="contact"
                                    name="contact"
                                    className={`inputField ${errors.contact ? 'border-red-500' : ''}`}
                        ...
                        <div className="flex flex-col mb-4">
                            ...
                            <textarea
                                ...
                                name="message"
                                rows="4"
                                className={`w-full border-b-2 border-gray-400 focus:outline-none focus:border-action ${errors.message ? 'border-red-500' : ''}`}
                    ...
                    <div className="flex justify-center mt-4">
                        <a href="#" className="text-action mx-2"><FaFacebook className="text-2xl" /></a>
                        <a href="#" className="text-action mx-2"><FaTwitter className="text-2xl" /></a>
                        <a href="#" className="text-action mx-2"><FaInstagram className="text-2xl" /></a>
                    </div>
                </div>
            </div>
        </section>
