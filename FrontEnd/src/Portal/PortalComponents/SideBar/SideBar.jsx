...
const SideBar = () => {
    ...
    return (
        <div className="flex">
            ...
            <div className={`bg-action  h-screen p-5 pt-8 absolute md:relative ${isOpen ? "w-72" : "w-20"} duration-500 md:block ${isSmallScreenOpen ? "block z-50 " : "hidden"} top-0 left-0`}>
                {!isSmallScreenOpen &&
                    <FaArrowLeft
                ...
                <div className="inline-flex">
                    ...
                    <h1 className={`text-white origin-left font-medium text-2xl duration-500 ${!isOpen && "scale-0"}`}>Less-Ego</h1>
                </div>
                    ...
                    {Menus.map((menu, index) => (
                        <React.Fragment key={index}>
                            <li
                                ...
                                className={`text-gray-300 text-2xl flex items-center gap-x-4 cursor-pointer p-2 hover:bg-secondary rounded-md ${menu.spacing ? "mt-9" : "mt-2"}`}>
                                <span>
